...
class CIFAR100(CIFAR10):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None,
                 download=False, category_list=None):
        ...
        if category_list:
            ...
            for new_label, category in enumerate(category_list):
                for idx,each in enumerate(self.targets):
                    if each == category:
                        self.data_new.append(self.data[idx])
                        self.targets_new.append(new_label)

            self.targets = self.targets_new
            self.data = np.array(self.data_new)
...
if __name__ == '__main__':
    ...
    train_set = CIFAR100(root='../data/CIFAR100/',train = True, transform=composed_transform,category_list=None)
    test_set = CIFAR100(root='../data/CIFAR100/',train = False,transform=composed_transform,category_list=None)
